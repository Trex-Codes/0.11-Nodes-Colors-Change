...
document.getElementById('Son2Color1').onclick = function() {
	...
	var calls2color1_4 = document.getElementById('fa2_Sub2');
	calls2color1_1.style.backgroundColor = 'red';
	calls2color1_2.style.backgroundColor = 'red';
	calls2color1_3.style.backgroundColor = 'red';
...
document.getElementById('Son2Color2').onclick = function() {
	...
	var calls2color2_4 = document.getElementById('fa2_Sub2');
	calls2color2_1.style.backgroundColor = 'blue';
	calls2color2_2.style.backgroundColor = 'blue';
	calls2color2_3.style.backgroundColor = 'blue';
...
document.getElementById('Son2Color3').onclick = function() {
	...
	var calls2color3_4 = document.getElementById('fa2_Sub2');
	calls2color3_1.style.backgroundColor = 'orange';
	calls2color3_2.style.backgroundColor = 'orange';
	calls2color3_3.style.backgroundColor = 'orange';
...
document.getElementById('Son2Color4').onclick = function() {
	...
	var calls2color4_4 = document.getElementById('fa2_Sub2');
	calls2color4_1.style.backgroundColor = 'purple';
	calls2color4_2.style.backgroundColor = 'purple';
	calls2color4_3.style.backgroundColor = 'purple';
...
document.getElementById('Son2Color5').onclick = function() {
	...
	var calls2color5_4 = document.getElementById('fa2_Sub2');
	calls2color5_1.style.backgroundColor = 'pink';
	calls2color5_2.style.backgroundColor = 'pink';
	calls2color5_3.style.backgroundColor = 'pink';
...
document.getElementById('Son2Color6').onclick = function() {
	...
	var calls2color6_4 = document.getElementById('fa2_Sub2');
	calls2color6_1.style.backgroundColor = 'green';
	calls2color6_2.style.backgroundColor = 'green';
