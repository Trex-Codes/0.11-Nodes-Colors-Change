function S1Call() {
	var CallcanvasSun = document.getElementById('cuadroSun2');
...
document.getElementById('s1color1').onclick = function() {
	...
	calls1color1_2.style.backgroundColor = 'red';
}

document.getElementById('s1color2').onclick = function() {
	...
	calls1color2_2.style.backgroundColor = 'blue';
}

document.getElementById('s1color3').onclick = function() {
	...
	calls1color3_2.style.backgroundColor = 'orange';
}

document.getElementById('s1color4').onclick = function() {
	...
	calls1color4_2.style.backgroundColor = 'purple';
}

document.getElementById('s1color5').onclick = function() {
	...
	calls1color5_2.style.backgroundColor = 'pink';
}

document.getElementById('s1color6').onclick = function() {
